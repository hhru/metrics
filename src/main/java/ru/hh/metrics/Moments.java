...
public class Moments {
  ...
  private static final AtomicReferenceFieldUpdater<Moments, MomentsData> UPDATER = AtomicReferenceFieldUpdater.newUpdater(Moments.class, MomentsData.class, "data");
